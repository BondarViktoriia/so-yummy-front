...
export const SharedLayoutBg = styled.div`
 padding-top: 114px;
  ...
  @media (min-device-pixel-ratio: 2),
    ...
    background-image: url(${squareLeftMob2x}),
      url(${squareCenterMob2x}), url(${squareRightMob2x});
  }
  ...
  @media screen and (min-width: 768px) {
    ...
    @media (min-device-pixel-ratio: 2),
      ...
      (min-resolution: 192dpi),
      (min-resolution: 2dppx) {
      background-image: url(${squareLeftDes2x}),
        url(${squareCenterDesk2x}), url(${squareRightDesk2x});
    }
  }
